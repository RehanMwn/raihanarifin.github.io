    ...
    if (isset($_GET['id'])) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $result = mysqli_query($mysqli, "UPDATE restoran SET nama='$nama', gambar='$gambar', alamat='$alamat', telepon='$telepon', jam_buka_jam_tutup='$jam_buka_jam_tutup', deskripsi='$deskripsi', menu='$menu', rating_restoran='$rating_restoran' WHERE id_restoran=$id");
