<div class="page">
        ...
        <form method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="number" name="rating" min="1" max="100" required autocomplete="off">
                    </td>
                </tr>
                <tr>
                    <td>Komentar</td>
                    <td>:</td>
                    <td>
                        <textarea name="komentar" required autocomplete="off"></textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input type="date" name="tanggal_review" required autocomplete="off">
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
    ...
    if(isset($_POST['submit'])) { // Mengubah kondisi menjadi if(isset($_POST['submit']))
        ...
        $result = mysqli_query($mysqli,$query); // Mengubah $mysql menjadi $mysqli
